...
#Transaction_amount_count by year for all df
...
#Transaction_amount_count by year,quarter for all df
...
#Aggre_user by brands in quarter
...
#top_insurance for transaction amount and pincodes
...
if select == "Data Exploration":
    ...
    if select == "Aggregated Analysis":
        ...
        if select == "Top Insurance":
            ...
            top_user_Y= top_user_plot_1(Map_user, years)
